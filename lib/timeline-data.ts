...
export const EVENTS: TimelineEvent[] = [  { year: 1988, date: "1 January", lane: "life", title: "Born in Kingston, Jamaica", tag: "Six in the morning, a Friday", body: "The first day of the year, which means every birthday since has arrived with the calendar turning over. The starting point for everything that follows." },
  ...
  { year: 2025, date: "10 August", lane: "stage", title: "Panel at The Shift Tradeshow",
    body: "The Shift: Changing of the Times, a Christian entrepreneur tradeshow hosted by Storhouse. Free to attend, expecting two hundred and fifty to four hundred, and he took it without an honorarium. Tracy was on the panel with him. The questions put to him were about how giving his life to Christ the year before changed the way he does business, and what someone actually does when the money, the network and the resources are not there yet.",
    plate: { src: "/images/the-shift-2025.jpg", w: 2000, h: 1333, alt: "Six panellists standing together in front of a lit Storhouse sign after The Shift Tradeshow session. From left to right: Ashley Gibbs, Mark Lorray, Dwayne, Rachael Baptiste, Troy Crossfield and Jai C.", caption: "The Shift Tradeshow, 10 August 2025." } },
