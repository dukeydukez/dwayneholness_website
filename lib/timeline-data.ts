...
export const EVENTS: TimelineEvent[] = [  { year: 1988, date: "1 January", lane: "life", title: "Born in Kingston, Jamaica", tag: "Six in the morning, a Friday", body: "The first day of the year, which means every birthday since has arrived with the calendar turning over. The starting point for everything that follows." },
  ...
  { year: 2009, lane: "film", title: "Fourteen productions, including Scott Pilgrim", tag: "Busiest year on record",
    body: "Background performer throughout: Scott Pilgrim vs. the World, Flashpoint, Copper, Harriet the Spy, and a Disney picture shooting under the code name Coin Flip." },
  ...
  { year: 2009, date: "September to October", lane: "film", title: "Three days at a camp in Haliburton for the Jonas Brothers", tag: "Logged under a code name",
    body: "Camp Rock 2: The Final Jam, shot at Kilcoo Camp in Minden and YMCA Camp Wanakita between 3 September and 16 October. Disney ran the production as Coin Flip to keep it quiet, which is the name that went onto his union record and stayed there, so for years the biggest job of that year read like a film nobody had heard of. Three engagements paid $2,014.23, about six hundred and seventy dollars a day. Seven days on Aaron Stone paid less. It is the highest day rate of his performing career and the second highest total of any production he has ever worked, behind only five seasons of Degrassi combined.",
    plate: { src: "/images/camp-rock-2009.jpg", w: 1200, h: 1600, alt: "Eleven background performers stacked in a human pyramid on the grass at a summer camp, picnic tables and trees behind them, every one wearing a production credential on a lanyard. Dwayne is front left, on hands and knees in a green hoodie.", caption: "Between setups at camp, autumn 2009." } },
  ...
  { year: 2012, date: "1 March", lane: "film", title: "Stay Schemin Toronto", tag: "His second most watched music video",
    body: "A posse cut for Torontorappers.com with C4, Corey Fila and Oatz over the Stay Schemin beat, credited in the title as Dir By DukeyDukez. At 266,037 views it is the second most watched music video he has directed, behind only Ego five years later. Counting everything, not just music, Hodan's Story sits between them." },
  ...
  { year: 2016, date: "September", lane: "stage", title: "First talk to a BizStart cohort", tag: "Youth Employment Services",
    body: "Casey B introduced him to Kofi Amoama, who ran youth entrepreneurship at Youth Employment Services on Richmond Street, with a line that did all the work: he is an inspiration to a lot of young entrepreneurs. Dwayne replied in the same hour. Let us do it, how is Tuesday. That first talk turned into a standing invitation, and Annie Lam kept calling: April 2017, that September, again in November, then March and September of 2018, by which point the cohort had doubled to forty-four. At least five sessions across three years, and in all of that correspondence a fee is never once discussed. What came back instead were people. A developer in the room offered to rebuild his website. A producer sent him beats afterwards and got an honest answer about why they did not feel full. And when a young woman he was mentoring, Chantaya Veira, set her heart on getting into BizStart, he wrote to Kofi himself to ask for an extra look at her application." },
  ...
  { year: 2017, date: "30 March", lane: "build", title: "Wins the first ArtWorksTO RFP round he enters", tag: "Two projects, two City divisions",
    body: "Ines Aguileta at the Neighbourhood Arts Network writes to say both proposals were successful: CP1, the Oakwood-Vaughan Revitalization Study, and SDFA4b, the Toronto Strong Neighbourhoods Strategy 2020. He and Leandra Legendre had spent February costing every project on the menu line by line, working out what was left for the artist after the twenty per cent Corex took to administer it. Oakwood-Vaughan came to $3,248.75 after tax across three invoices, of which Corex kept $649.75. Small money. What it bought was a standing relationship with two City divisions and a place in a network he is still inside a decade later." },
  { year: 2017, date: "4 June", lane: "film", title: "Shoots Ego in Los Angeles", tag: "His biggest music video",
    body: "For Just Chase, and about forty thousand dollars of production. Call time was ten in the morning at 5610 Soto Street in Huntington Park, with Department 4 running the floor and a second unit picking up aerials of the LA skyline and night driving under the palms. He cut it himself through June. Six weeks later he was on a plane to Somalia. The video came out on 14 September, three months after the shoot, and Complex ran a piece on it the same day. The track behind it was produced by WondaGurl. It has since passed 1.7 million views, about six times the next highest music video he has directed and nearly four times Hodan's Story, which is the most watched thing he has made outside music." },
  ...
  { year: 2018, date: "24 January", lane: "stage", title: "Toronto Tastemakers panel", tag: "Central YMCA, Grosvenor Street",
    body: "Kwaku Agyemang was an actor and a media student at Ryerson when he built Toronto Tastemakers and put Dwayne on the panel beside Steve Mann of Mann Casting, Raymond Ablack of Degrassi, Meisha Watson of YTV and Amanda Parris of CBC. Doors at six in the Central YMCA auditorium on Grosvenor, panel until half past eight, mixer until half past nine. It was the organizers' first event and it sold through Eventbrite. A hundred dollars, sent by e-transfer the following week. The bio he supplied for the program is a snapshot of exactly where he stood that January: Coca-Cola, TD and Rogers as clients, the media program he had built at POV 3rd Street, and 6ix Rising two months old. The morning after, a Ryerson student who had been in the room emailed asking how to break into styling for music videos. He answered in four minutes with one name and told her to go slide into the DMs.",
    plate: { src: "/images/tastemakers-2018.jpg", w: 2000, h: 1333, alt: "Dwayne mid-answer at a panel table, hand raised toward a microphone on a stand, two other panellists seated to his right against a pale brick wall.", caption: "Toronto Tastemakers, 24 January 2018." } },
  { year: 2018, date: "7 March", lane: "stage", title: "The Vortex Workshop at York Memorial", tag: "Eighty-five grade nine boys",
    body: "Shelle Rankine was the child and youth worker at York Memorial Collegiate, and she wanted a half day for the boys who turned up to school every morning and then did not go to class. His rate for a half day was three to four thousand dollars. Her budget was five hundred, and she told him so plainly. He took it, and said he would run it as if he were being paid the full rate. Eighty-five grade nine boys in the auditorium on the seventh of March, then three breakout rooms thirty minutes each, then everyone back in the auditorium to close. Masculinity, perception, self-worth. He brought Femi Lawson and Balu Kanagalingam and the three of them called it the Vortex Workshop. The only thing he asked for beyond the money was a letter of endorsement for his speaking resume. Rankine wanted to make it annual and she got two years out of it: he was back on the seventh of March 2019, invoiced at fifteen hundred, and eleven days later she was asking for Balu by name to help with restorative work after a fight at the school. She was booking a third round for April 2020, and George Harvey Collegiate alongside it, when the schools closed. One more approach came in February 2021, a teacher with funding in hand for a year-long boys' leadership program, but the pricing never met the board's number. Two years is what it ran." },
  ...
  { year: 2018, date: "13 August", lane: "build", title: "Judges the ArtWorksTO RFP he won", tag: "Sixteen months later",
    body: "Ines invited him onto the selection committee for the Youth Communications Project. He read the proposals and sat the adjudication, deciding who got the contracts, a year and a bit after being on the other end of the same envelope. It is the first time he does this. He does it again for the Ontario Arts Council in February 2025 and the Toronto Arts Council five months after that." },
  ...
  { year: 2021, date: "23 February", lane: "stage", title: "Young, Black and Gifted", tag: "Black History Month, hosted by Tridel",
    body: "Agapi Gessesse, executive director of the CEE Centre for Young Black Professionals, put him on a Black History Month panel with Abigail Moriah and Hackim Farrell, hosted by Tridel. It was booked for 9 February and moved to the twenty-third because Tridel wanted longer to promote it. The bio he sent for it opens with three words other people had used about him, and lists TD Bank, Umbro, Coca-Cola and CSA. Three months later CEE would hand him a payroll of forty-eight." },
  { year: 2021, date: "16 April", lane: "stage", title: "A Zoom call with Tory Lanez", tag: "Ten years after Vola Lounge",
    body: "They had shared a bill at Vola Lounge on Caribana weekend in 2011, when Lanez was not yet Lanez. Ten years later it was a Zoom, and Lanez spent it on a single point: that Dwayne had always been the one who cleared the bar and then went past it, and that he should keep doing exactly that. Nothing commercial came of the call. It is on the record because of who said it and how long the gap was.",
    voice: { text: "I commend you, bro. Don't stop. Just keep on going, keep going hard. You've always been somebody doing something bigger than everybody else. The quota was always there, and you always kind of just outdid it. Keep outdoing yourself.", who: "Tory Lanez", when: "16 April 2021" } },
  ...
  { year: 2022, date: "31 March", lane: "stage", title: "Teaches personal branding to a cybersecurity cohort", tag: "Called in three days out",
    body: "CEE's programme coordinator Danielle Gilmore lost a facilitator and was given his name by their curriculum developer. An hour on personal branding for ten people learning IT security, delivered on the Thursday. What is worth noticing is the reply he sent to a last-minute favour: eight numbered questions, including how many were attending, whether it was recorded, whether it was paid, and what the budget was. He signed a vendor contract for it. Twenty years after forty-six dollars for eight hours, nobody gets the work for free because they asked nicely." },
  { year: 2022, date: "8 October", lane: "film", title: "Hodan's Story premieres on CBC", tag: "Written and directed",
    body: "A portrait of the friend and mentor he met at FEVA TV, which he both wrote and directed. His CBC debut. Three years after her death, he puts her on national television himself. CBC Docs posted it to YouTube under a headline that is really her whole argument: positive Somali stories, they told her nobody wanted to hear them, so she proved them wrong. It has 453,955 views and 4,247 likes there, which makes it the most watched thing he has directed that is not a music video, and the case she spent her career making is still being won on a channel she never got to see it on.",
  ...
  { year: 2024, date: "April", lane: "stage", title: "TIFF Next Wave, Thriving as an Artist", tag: "Put forward by ArtWorksTO",
    body: "A panel at the Toronto International Film Festival's youth program, presented with Toronto Film School. Ines Aguileta of the Toronto Arts Foundation invited him in February, on the Young Creators Co-Lab bill with Sid Naidu, Cristal Buemi and Betty Xie.",
  ...
  { year: 2024, date: "24 July", lane: "stage", title: "Speaks at the Jean Augustine Chair, York University", tag: "Black Youth Internship Program",
    body: "The Jean Augustine Chair in Education, Community and Diaspora sits in York University's Faculty of Education, named for the first Black woman elected to the House of Commons. Its Black Youth Internship Program had twenty-four secondary students on campus that summer, all of them heading into grade eleven, and Melissa McKay put his name forward. Half past nine in the morning, one hour, the Mac Lab on the third floor of the Dahdaleh Building. He drove down with his video team. The students had asked for editing, animation and programming, so that is what he came to talk about. When he asked the organizers beforehand what the biggest issue was that needed addressing, the answer had nothing to do with the subject.",
    ...
    voice: { text: "Seeing a Black male that is successful in person is wonderful.", who: "LaToya Hinds, Black Youth Internship Program", when: "2024" } },
  ...
  { year: 2024, date: "9 September", lane: "stage", title: "Guest on a Schulich ExecEd program", tag: "Brought in as the case study",
    body: "Mawuli Chai of Iconic Media Group was delivering Business and Leadership Essentials through Schulich ExecEd at the Schulich School of Business, coordinated by Stefania Gargaro and running on York University's own Zoom. He brought Dwayne in for session one and told the programme lead why: he wanted to feature Corex as an example of great business practice, in question and answer form. Eight in the evening, the ninth of September. Let us create a firestorm of positivity, is how the invitation put it. It was the first of three Septembers in a row." },
  ...
  { year: 2025, date: "28 April", lane: "build", title: "Hosts an ArtWorksTO participant, second year running", tag: "Alumnus to host",
    body: "He won their very first RFP round back in 2017 and judged the next one in 2018. Now he sits on the other end of it, submitting a project brief so the program can place a young creative on paid Corex work. In 2024 that was Yve Lu Trinh, who built the Creativeworld site. In 2025 Norma Garcia matched him with Stephanie Hanson, who directed a five thousand dollar Corex brand film and interviewed him, Femi Lawson and Danielle Pinnock for it. She handed in the last deliverables that September. The relationship widened past hosting. They put him on the Workforce Development Roundtable at OCAD U in September 2024, invited him as a special guest to the first Industry Night that same month and the next one in June 2025, and Ines Aguileta at the Toronto Arts Foundation is who put him forward as a guest speaker for TIFF Next Wave. By 2026 the program was still sending him people: a cohort member emailed asking to join the Branded mentorship. The council that trained him now uses him to train others." },
  ...
  { year: 2025, date: "14 to 16 July", lane: "stage", title: "Judges the Toronto Arts Council's Black Arts Projects", tag: "Second council in one year",
    body: "Onika Powell invited him on 18 June and he signed the peer assessor agreement and the conflict of interest form the same day. Three days on the jury with Yung Yemi, Queen Kukoyi of Oddside Arts and Jadyn Hardie-Bardy, reading applications and deciding who gets funded. Five months after doing the same for the Ontario Arts Council, so two arts councils inside a year. The following spring he applied to that same Black Arts stream himself and was awarded seven thousand dollars for the Jamaica Strong film.",
    quote: "I can't wait to see these artists flourish." },
  ...
  { year: 2025, date: "15 September", lane: "stage", title: "The Black Leadership Experience webinar", tag: "Mawuli, a year later",
    body: "Challenges and Opportunities, and the second time Mawuli Chai put him in front of a room of entrepreneurs. He sent a full question set ahead, on the pivotal moments, on how identity and lived experience shape a leadership style, on what is specifically hard about leading while Black. Then he wrote again two days out and told him to hold the script loosely. He was back a year later for the third.",
    voice: { text: "I don't want the questions to feel too rehearsed. I really want you to just be yourself, because that's where the magic happens. That's where the real transformation takes place, and it's exactly why I chose you as my number one.", who: "Mawuli Chai", role: "Iconic Media Group", when: "12 September 2025" } },
  ...
  { year: 2026, date: "5 March", lane: "stage", title: "Business Weekly, on the infrastructure of influence", tag: "The thesis, out loud",
    body: "A live episode for EMPIRE by Design, booked after Jai Holness sent him the link on LinkedIn. The producers sent their questions ahead and every one of them was his argument put back to him: why visibility creates momentum but not scale, what media infrastructure actually is behind the scenes, what sits underneath the companies that convert attention into influence. He wrote it up himself the next morning. Most founders have visibility. They do not have scale." },
  ...
  { year: 2026, date: "18 June", lane: "stage", title: "Three podcasts as the guest, not the host", tag: "All three came to him",
    body: "An hour with Paul Gittens on The WHO Project, recorded on the eighteenth and out on iHeart on the twenty-seventh: forty-five minutes on financial setbacks, rebuilding an identity and what ownership actually costs. It was the third of the year and none of them were pitched. Business Weekly came through a LinkedIn introduction in March. Nathan Bennett booked The Extraordinary Exchange in May after reading his post about losing a hundred and thirty thousand dollars in ninety days, which is to say the thing that got him invited on was the failure, not the wins. He spent years building a room of his own with Creative Connect. This is the year he found he could carry the same argument into other people's." },
  ...
  { year: 2026, date: "9 September", lane: "life", title: "Redway back on screen, in the Tory Lanez video", tag: "Eleven years after",
    body: "Tory Lanez put out the video for Hasty Market // Toronto, with HollywoodSos, on One Umbrella Records, and it pulled the whole city into one frame. Artists and influencers from every corner of Toronto turned up for it, rivals among them, standing in shots they would not otherwise share. A video like this had not been made here before. One section is a homage to Shane Redway, and that is the part Dwayne is in. Look at who is on the porch with him: Femi Lawson seated in the red varsity, nineteen years after the two of them started Dukez and Bullet, and MC Breezyy standing beside the plaque, fifteen years after he was on that Vola Lounge bill with Lanez. Eleven years after Redway died the city put him back on screen, and the room that made him is the room that showed up. Lanez was not on set. He is serving a ten-year sentence in California.",
    plate: { src: "/images/tory-lanez-toronto-2026.jpg", w: 2000, h: 936, fit: "whole", alt: "A black-and-white frame from the video with red picked out on two varsity jackets. Seven men on a porch at night around a framed record plaque, a signed memorial board and photographs of Shane Redway.", caption: "The Redway homage in Tory Lanez, Hasty Market // Toronto, released 9 September 2026. Left to right: Jordan, MC Breezyy, Charles and Femi Lawson seated, Moses and Mike standing behind them, and Dwayne on the right." } },
  { year: 2026, date: "21 September", lane: "stage", title: "Back at Schulich ExecEd", tag: "Mawuli, year three",
    body: "The third September running that Mawuli Chai put him in front of his cohort, this time Module 2 of the Business and Leadership Essentials certificate, Self-Leadership and Coaching, shared with coach Susan Crawford of Meraki Inspired. Close to an hour of questions on Zoom. He told the room about being laughed at at twenty-one for saying he wanted to be a boss, about his mother kicking him out over the hours on the computer and the house that same work later bought her, about 2021 arriving so fast it nearly broke him, and about Hodan. When Mawuli asked the cohort to finish the sentence because of this conversation, I will, one of them sent his own line back: sometimes you feel like you are buried, but you are planted.",
    voice: { text: "As you were talking today, one of the things that kept coming up in my head was how dare you? How dare you not shout from the rooftops what has been put in your spirit to share?", who: "Susan Crawford", role: "Meraki Inspired, co-facilitator", when: "21 September 2026" } },
  { year: 2026, date: "25 September", lane: "stage", title: "The Extraordinary Exchange goes live", tag: "From Jamaica to Canada",
    body: "The episode Nathan Bennett booked in May, after reading about the hundred and thirty thousand dollars lost in ninety days, went out on the Extraordinary Investment Group channel on the twenty-fifth. They titled it From Jamaica to Canada: How Dwayne Holness Built an Influential Creative Empire Through Purpose. The conversation covers most of this page: the move from Kingston, his mother's sacrifice, Jane and Finch and the stories usually told about it, the camera he lost that had launched his career, and the last-minute job that led to work with Lauryn Hill's team. He was invited on for the failure. What they published was the whole arc.",
    plate: { src: "/images/extraordinary-exchange-2026.jpg", w: 2000, h: 1117, fit: "whole", alt: "The Extraordinary Exchange Podcast episode card: the green title From Jamaica to Canada on black marble at left, Dwayne at right in a striped knit shirt, one finger raised to his cheek, against a green backdrop.", caption: "The Extraordinary Exchange Podcast, episode 54, 25 September 2026." } },
];
