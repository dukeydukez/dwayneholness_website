...
export const EVENTS: TimelineEvent[] = [
  ...
  { year: 2014, date: "30 October", lane: "stage", title: "Runner-up, Youth Arts Pitch Contest", tag: "Twenty-five hundred dollars",
    body: "Scarborough Civic Centre, and the first time he pitches the business in public. The cheque is made out to Corex, memo line Creative Business and Career Development, and half a dozen people are standing behind it in Corex Creative shirts. The company was twenty-two months old.",
    plate: { src: "/images/artreach-pitch-2014.jpg", w: 2000, h: 1333, alt: "Dwayne and five colleagues in Corex Creative t-shirts holding an oversized cheque reading Youth Arts Pitch Contest 2014, pay to the order of Corex, two thousand five hundred dollars.", caption: "Youth Arts Pitch Contest, 30 October 2014." } },
