...
export const EVENTS: TimelineEvent[] = [  { year: 1988, date: "1 January", lane: "life", title: "Born in Kingston, Jamaica", tag: "Six in the morning, a Friday", body: "The first day of the year, which means every birthday since has arrived with the calendar turning over. The starting point for everything that follows." },
  ...
  { year: 2026, date: "21 September", lane: "stage", title: "Back at Schulich ExecEd", tag: "Mawuli, year three",
    body: "The third September running that Mawuli Chai put him in front of his cohort, this time Module 2 of the Business and Leadership Essentials certificate, Self-Leadership and Coaching, shared with coach Susan of Meraki Inspired. Close to an hour of questions on Zoom. He told the room about being laughed at at twenty-one for saying he wanted to be a boss, about his mother kicking him out over the hours on the computer and the house that same work later bought her, about 2021 arriving so fast it nearly broke him, and about Hodan. When Mawuli asked the cohort to finish the sentence because of this conversation, I will, one of them sent his own line back: sometimes you feel like you are buried, but you are planted.",
    voice: { text: "As you were talking today, one of the things that kept coming up in my head was how dare you? How dare you not shout from the rooftops what has been put in your spirit to share?", who: "Susan", role: "Meraki Inspired, co-facilitator", when: "21 September 2026" } },
];
