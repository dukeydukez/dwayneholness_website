...
export const EVENTS: TimelineEvent[] = [  { year: 1988, date: "1 January", lane: "life", title: "Born in Kingston, Jamaica", tag: "Six in the morning, a Friday", body: "The first day of the year, which means every birthday since has arrived with the calendar turning over. The starting point for everything that follows." },
  ...
  { year: 2026, date: "February", lane: "stage", title: "BMO features him for Black History Month", tag: "He edited the bank's copy",
    ...
    plate: { src: "/images/bmo-feature-2026.jpg", w: 2000, h: 1333, alt: "The Corex Creative team, eight of them in branded black polos holding cinema and stills cameras, posed together in front of a wall-sized Toronto skyline.", caption: "The team, from the set of photographs he sent BMO for the feature." } },
