...
export const EVENTS: TimelineEvent[] = [  { year: 1988, date: "1 January", lane: "life", title: "Born in Kingston, Jamaica", tag: "Six in the morning, a Friday", body: "The first day of the year, which means every birthday since has arrived with the calendar turning over. The starting point for everything that follows." },
  ...
  { year: 2026, date: "9 February", lane: "stage", title: "BMO features him for Black History Month", tag: "He edited the bank's copy",
    body: "It came through his own relationship manager. Obot Egbo-Egbo put him in front of BMO's marketing team rather than the other way round, and Migena Latifi wrote back that it was their absolute honour to feature him on the Business Banking page. He asked for it to run in the new year because his birthday is 1 January and he wanted it as a present. Then he shaped it. In December he asked them to work Jamaica Strong into the copy given the Black History Month timing, and the bank rewrote the post to carry it. In January he asked for one more change, that the relief effort be named as Jamaica Strong rather than credited loosely to his team, and they took his wording. A month later BMO's own account called Corex proof that purpose and profit can coexist. Their draft opened on a line he did not write but might as well have: stories can spark change.",
